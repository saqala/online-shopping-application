...
VALUES ('Virat', 'Kohli', 'ADMIN', true, '$2a$06$Kddh7j47q6FadIgijvQBmOON0oXwpV7LXRuS9L/VMBBw8WqNt2j6y', 'vk@gmail.com', '8888888888');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
...
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Khozema', 'Nullwala', 'USER', true, '$2a$04$eDgl8dN.Ok5mYm6nyfk3oOicxkEOiJYDhFXCz.aYfixOSvcsgnkO.', 'user@slimanitech.com', '7777777777');
-- slimani pass
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ilias', 'Slimani', 'ADMIN', true, '$2a$04$eDgl8dN.Ok5mYm6nyfk3oOicxkEOiJYDhFXCz.aYfixOSvcsgnkO.', 'ilias.slimani@slimanitech', '8888888888');
