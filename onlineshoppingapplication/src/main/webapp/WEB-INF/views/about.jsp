		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="${images}/ilias.jpg" alt=" " class="img-responsive" />
					<h4>SLIMANI ILIAS</h4>
					<p>Software Engineer</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="linkedin.com/in/ilias-slimani" class="Linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
						<li><a href="https://slimanitech.me/" class="twitter"><i class="fa fa-globe" aria-hidden="true"></i></a></li>
						<li><a href="ilias.slimani@edu.uiz.ac.ma" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
					</ul>
				</div>
				<div class="col-md-3 agileits_team_grid">
					<img src="${images}/ziani.jpg" alt=" " class="img-responsive" />
					<h4>ZIANI YOUCEF</h4>
					<p>Software Engineer</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="linkedin.com/in/ilias-slimani" class="Linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
