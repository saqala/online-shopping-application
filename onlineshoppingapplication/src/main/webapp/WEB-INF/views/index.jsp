...
<security:authorize access="hasAuthority('USER')">
		...
		<div class="w3l_header_right">
			<ul>
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i aria-hidden="true">${userModel.fullName}</i><span class="caret"></span></a>

				<div class="mega-dropdown-menu">
					<div class="w3ls_vegetables">
						<ul class="dropdown-menu drp-mnu">
							<security:authorize access="hasAuthority('USER')">
							<li><a href="${contextRoot}/cart/show">			                        	<span class="fa fa-shopping-cart"></span>&#36;<span class="badge">${userModel.cart.cartLines}</span> - &#36; ${userModel.cart.grandTotal} 
							</a></li> 
...
<div class="logo_products">
	<div class="container">
		<div class="w3ls_logo_products_left">
			<h1><a href="${contextRoot}/home"><span>Grocery</span> Store</a></h1>
		</div>
