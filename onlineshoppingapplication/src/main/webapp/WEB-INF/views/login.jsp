...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="${contextRoot}/home">Home</a><span>|</span></li>
...
<a href="${contextRoot}/register">REGISTER HERE</a>
				  ...
				  <div class="form">
					...
					<form action="${contextRoot}/login" method="post">
					  <input type="text" name="username" placeholder="me@slimanitech.com" required=" ">
